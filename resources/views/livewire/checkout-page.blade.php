			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<div class="mb-6">
					...
					<div class="mt-4">
						...
						dark:border-none"  @error('street_address') border-red-500 @enderror id="address" type="text">
						</input>
					...
					<div class="mt-4">
						...
						<input wire:model='city' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white 
						dark:border-none"  @error('city') border-red-500 @enderror id="city" type="text">
						</input>
						@error('city')
							<div class="text-red-500 text-sm">
								{{ $message }}
					...
					<div class="grid grid-cols-2 gap-4 mt-4">
						<div>
							...
							<input wire:model='state' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white 
							dark:border-none"  @error('state') border-red-500 @enderror id="state" type="text">
							</input>
							@error('state')
								<div class="text-red-500 text-sm">
									{{ $message }}
						...
						<div>
							...
							<input wire:model='zip_code' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white 
							dark:border-none" @error('zip_code') border-red-500 @enderror id="zip" type="text">
							</input>
							@error('zip_code')
								<div class="text-red-500 text-sm">
									{{ $message }}
